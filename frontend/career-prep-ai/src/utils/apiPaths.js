...
export const API_PATHS = {
  ...
  AI: {
    GENERATE_QUESTIONS: "/api/ai/generate-questions", //Generate interview questions ans answers using Gemini
    GENERATE_EXPLANATION: "/api/ai/generate-explanation", //Generat concept explanation using Gemini
  },
